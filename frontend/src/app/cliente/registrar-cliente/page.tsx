...
async function onSubmit(e: React.FormEvent) {
  ...
  try {
    setLoading(true);
    const base =
      process.env.NEXT_PUBLIC_API_BASE_URL || "https://scmvp-1jhq.onrender.com";
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div className="rounded border border-gray-200 p-4 space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Captura manual por ahora (no catálogo). En iteraciones posteriores lo
          alineamos a catálogos.
        </p>
        ...
        <div className="rounded border border-gray-200 p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              ...
              />
              {errors["persona.rfc"] ? (
                <p className="text-xs text-red-600">{errors["persona.rfc"]}</p>
              ) : null}
            </div>
            ...
            <div className="space-y-1">
              ...
              />
              {errors["persona.curp"] ? (
                <p className="text-xs text-red-600">{errors["persona.curp"]}</p>
              ) : null}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onBlur={() =>
                    validateField("persona.direccion_privada.ciudad_delegacion")
                  }
                />
              ...
              {pfManifiestaTerceros ? (
                <div className="rounded border border-gray-200 p-3 space-y-3">
                  <p className="text-xs text-gray-600">
                    En caso de responder que sí, llena la información adicional
                    para identificar al dueño beneficiario y/o tercero.
                  </p>
        ...
        <div className="rounded border border-gray-200 p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              ...
              />
              {errors["empresa.rfc"] ? (
                <p className="text-xs text-red-600">{errors["empresa.rfc"]}</p>
              ) : null}
            </div>
            ...
            <div className="space-y-1 md:col-span-3">
              ...
              {errors["representante.nombre_completo.pm"] ? (
                ...
                <p className="text-xs text-gray-500">
                  El backend actual valida nombre_completo; lo enviamos generado
                  si lo dejas vacío.
                </p>
              )}
            </div>
